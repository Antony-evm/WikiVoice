  ...
  <div
    ...
    <div class="w-full max-w-md mx-auto">
      <div class="text-center mb-8">
        ...
        <h2 class="text-lg text-[var(--text-primary)] font-serif italic opacity-70">Login to WikiVoice</h2>
      </div>
      ...
      <form @submit.prevent="handleLogin"
        ...
        <p class="mt-6 text-center text-[var(--text-secondary)] font-serif italic text-sm">
          ...
          <router-link to="/register" class="text-[var(--primary)] hover:underline ml-1 font-semibold">
            Request access
          </router-link>
        </p>
      </form>
