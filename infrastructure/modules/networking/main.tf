...
# Elastic IPs for NAT Gateways (optional - only if nat_gateway_count > 0)
...
# NAT Gateways (optional - only if nat_gateway_count > 0)
...
resource "aws_route_table" "private" {
  ...
  # Only add NAT route if NAT Gateway exists
  dynamic "route" {
